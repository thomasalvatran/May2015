//home/tovantran/Ctest/May30LinkedListQueue.cpp --> 2015-05-31 by ./.tv  owner: tovantran
//class double circulate linkedlist, insert head, insert tail, insert middle, sort, search, queue, enqueue, dequeue
#include <iostream>
#include <stdlib.h>
#include <string>
using namespace std;
